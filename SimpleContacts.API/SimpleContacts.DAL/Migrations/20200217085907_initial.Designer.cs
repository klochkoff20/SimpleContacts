...
namespace SimpleContacts.DAL.Migrations
{
    ...
    [Migration("20200217085907_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.CandidatesLanguages", b =>
                {
                    b.Property<Guid>("CandidateId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.CandidatesSkills", b =>
                {
                    b.Property<Guid>("CandidateId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.VacanciesLanguages", b =>
                {
                    b.Property<Guid>("VacancyId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("VacancyId", "LanguageId");

                    b.HasIndex("LanguageId");

                    b.ToTable("VacanciesLanguages");
                });
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.Vacancy", b =>
                {
                    ...
                    b.Property<byte>("VacancyPriority")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.Candidate", b =>
                {
                    ...
                    b.HasOne("SimpleContacts.Entities.Entities.User", "ResponcibleUser")
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.CandidatesLanguages", b =>
                {
                    b.HasOne("SimpleContacts.Entities.Entities.Candidate", "Candidate")
                        .WithMany("CandidatesLanguages")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SimpleContacts.Entities.Entities.Language", "Language")
                        .WithMany("CandidatesLanguages")
            ...
            modelBuilder.Entity("SimpleContacts.Entities.Entities.CandidatesSkills", b =>
                {
                    ...
                    b.HasOne("SimpleContacts.Entities.Entities.Skill", "Skill")
                        .WithMany("CandidatesSkills")
